...
Config['Weapons'] = {
	-- Addon
	{name = 'WEAPON_BAT+1', label = 'bat +1', components = {}},
	{name = 'WEAPON_BAT+2', label = 'bat +2', components = {}},
	{name = 'WEAPON_BAT+3', label = 'bat +3', components = {}},
	{name = 'WEAPON_BAT+4', label = 'bat +4', components = {}},
	{name = 'WEAPON_BAT+5', label = 'bat +5', components = {}},

	{name = 'WEAPON_POOLCUE+1', label = 'pool cue +1', components = {}},
	{name = 'WEAPON_POOLCUE+2', label = 'pool cue +2', components = {}},
	{name = 'WEAPON_POOLCUE+3', label = 'pool cue +3', components = {}},
	{name = 'WEAPON_POOLCUE+4', label = 'pool cue +4', components = {}},
	{name = 'WEAPON_POOLCUE+5', label = 'pool cue +5', components = {}},

	{name = 'WEAPON_HAMMER1', label = 'HAMMER +1', components = {}},
	{name = 'WEAPON_HAMMER2', label = 'HAMMER +2', components = {}},
	{name = 'WEAPON_HAMMER3', label = 'HAMMER +3', components = {}},
	{name = 'WEAPON_HAMMER4', label = 'HAMMER +4', components = {}},
	{name = 'WEAPON_HAMMER5', label = 'HAMMER +5', components = {}},

	{name = 'NEW_WEAPON_REVOLVER_1', label = 'REVOLVER +1', components = {}},
	{name = 'NEW_WEAPON_REVOLVER_2', label = 'REVOLVER +2', components = {}},
	{name = 'NEW_WEAPON_REVOLVER_3', label = 'REVOLVER +3', components = {}},
	{name = 'NEW_WEAPON_REVOLVER_4', label = 'REVOLVER +4', components = {}},
	{name = 'NEW_WEAPON_REVOLVER_5', label = 'REVOLVER +5', components = {}},
	{
		name = 'WEAPON_PISTOL',
